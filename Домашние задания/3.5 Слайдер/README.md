...
Домашнее задание к занятию 3.5 «Работа с DOM: события и навигация по элементам».
...
| Файл | Назначение |
|------|------------|
| `task.html` | Разметка слайдера: слайды, стрелки «влево»/«вправо», блок точек (повышенная сложность) |
| `task.css` | Отображение одного активного слайда, стили стрелок и точек |
| `task.js` | Регистрация кликов по стрелкам и точкам, бесконечная прокрутка, синхронизация активной точки со слайдом |
